...
- (void)viewDidLoad {
    ...
    UILabel *label3 = [[UILabel alloc] initWithFrame:CGRectMake(40, _height+45, SCREEN_WIDTH/2-40, 20)];
    ...
    UILabel *label4 = [[UILabel alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2+20, _height+45, SCREEN_WIDTH/2-20, 20)];
    ...
    UIView *containerView = [[UIView alloc] initWithFrame:CGRectMake(0, _height+75, SCREEN_WIDTH, SCREEN_HEIGHT-_height-80)];
